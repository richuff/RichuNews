...
(function(vue) {
  ...
  const S = true, b = "app", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "26.7.59.104",\n        "192.168.121.1",\n        "192.168.3.1",\n        "10.33.47.47"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"alipay","spaceName":"richucloudapp","spaceId":"env-00jxgxphlbhr","spaceAppId":"2021004156613024","accessKey":"soKk8s4jY4VmUC2T","secretKey":"QWdLGfz9QYG46Uwj"}]') || [];
  let O = "";
  try {
    O = "__UNI__5DCD013";
  } catch (e2) {
...
详细信息：${s4}`), r3(i3);
  ...
  const __easycom_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$4], ["__scopeId", "data-v-d31e1c47"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/uni_modules/uni-icons/components/uni-icons/uni-icons.vue"]]);
  const _sfc_main$8 = {
    __name: "index",
    setup(__props) {
      let listArr = vue.ref([]);
      ...
      const getDatetime = vue.computed(() => (index) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "content" }, [
          vue.createElementVNode("view", { class: "context" }, [
            (vue.openBlock(true), vue.createElementBlock(
              vue.Fragment,
              null,
              vue.renderList(vue.unref(listArr), (item, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  onClick: ($event) => goDetail(item._id),
                  class: "item",
                  key: item._id
                }, [
                  vue.createElementVNode("view", { class: "text" }, [
                    ...
                    vue.createElementVNode("view", { class: "info" }, [
                      ...
                      vue.createElementVNode(
                        "text",
                        { class: "time" },
                        vue.toDisplayString(getDatetime.value(index)),
                        1
                        /* TEXT */
                      ),
                      vue.createElementVNode(
                        "view",
                        null,
                        vue.toDisplayString(vue.unref(locationed)),
                        1
                        /* TEXT */
                      )
                    ])
                  ]),
                  item.imageURL.length ? (vue.openBlock(), vue.createElementBlock("image", {
                    key: 0,
                    src: item.imageURL[0],
                    mode: "aspectFill",
                    class: "bac"
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-1cf27b2a"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/pages/index/index.vue"]]);
  ...
  const uploadImage = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$3], ["__scopeId", "data-v-bdfc07e0"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/uni_modules/uni-file-picker/components/uni-file-picker/upload-image.vue"]]);
  const _sfc_main$6 = {
    name: "uploadFile",
    emits: ["uploadFiles", "choose", "delFile"],
    props: {
  ...
  const uploadFile = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$2], ["__scopeId", "data-v-a54939c6"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/uni_modules/uni-file-picker/components/uni-file-picker/upload-file.vue"]]);
  const _sfc_main$5 = {
    name: "uniFilePicker",
    components: {
      uploadImage,
    ...
    methods: {
      ...
      chooseFiles() {
        ...
        Ws.chooseAndUploadFile({
          ...
          formatAppLog("log", "at uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue:374", "选择失败", err);
        });
      },
      /**
       * 选择文件回调
      ...
      uploadFiles(files) {
        ...
        return uploadCloudFiles.call(this, files, 5, (res) => {
          ...
          formatAppLog("log", "at uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue:447", err);
        });
      },
      /**
       * 成功或失败
  ...
  const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$1], ["__scopeId", "data-v-6223573f"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue"]]);
  const _sfc_main$4 = {
    __name: "Add",
    setup(__props) {
      let detail = vue.ref({});
      vue.ref("##666");
      let isshowbutton = vue.ref(true);
      let imageValue = vue.ref([]);
      ...
      const Uploadsuccess = (e2) => {
        let tempFiles = e2.tempFilePaths;
        Ws.getTempFileURL({
          fileList: tempFiles
        }).then((res) => {
              ...
              [
                vue.withDirectives(vue.createElementVNode(
                  "input",
                  {
                    ...
                    placeholder: "请输入标题",
                    class: "title",
                    "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.unref(formdata).title = $event)
                  },
                  null,
                  512
                  /* NEED_PATCH */
                ), [
                  [vue.vModelText, vue.unref(formdata).title]
                ]),
                vue.withDirectives(vue.createElementVNode(
                  "input",
                  {
                    ...
                    placeholder: "请输入作者",
                    class: "author",
                    "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => vue.unref(formdata).author = $event)
                  },
                  null,
                  512
                  /* NEED_PATCH */
                ), [
                  [vue.vModelText, vue.unref(formdata).author]
                ]),
                vue.withDirectives(vue.createElementVNode(
                  "textarea",
                  {
                    ...
                    class: "context",
                    placeholder: "请输入详细内容",
                    "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => vue.unref(formdata).context = $event)
                  },
                  "\r\n				",
                  512
                  /* NEED_PATCH */
                ), [
                  [vue.vModelText, vue.unref(formdata).context]
                ]),
                vue.createElementVNode("view", { class: "file" }, [
                  vue.createVNode(_component_uni_file_picker, {
                    modelValue: vue.unref(imageValue),
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = ($event) => vue.isRef(imageValue) ? imageValue.value = $event : imageValue = $event),
                    fileMediatype: "image",
                    mode: "grid",
                ...
                vue.createElementVNode("button", {
                  ...
                  type: "primary",
                  "form-type": "submit",
                  disabled: isDisable(vue.unref(formdata)) || !vue.unref(isshowbutton)
                }, "发布", 8, ["disabled"])
              ],
              32
              /* NEED_HYDRATION */
  ...
  const PagesAddAdd = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-d85b74b4"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/pages/Add/Add.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render], ["__scopeId", "data-v-9245e42c"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/uni_modules/uni-load-more/components/uni-load-more/uni-load-more.vue"]]);
  const _sfc_main$2 = {
    __name: "Edit",
    setup(__props) {
      let id = vue.ref("");
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", null, [
          vue.unref(isshow) ? (vue.openBlock(), vue.createElementBlock("view", {
            ...
            vue.createElementVNode("form", { class: "message" }, [
              vue.withDirectives(vue.createElementVNode(
                "input",
                {
                  type: "text",
                  ...
                  placeholder: "请输入标题",
                  class: "title",
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => vue.unref(detail).title = $event)
                },
                null,
                512
                /* NEED_PATCH */
              ), [
                [vue.vModelText, vue.unref(detail).title]
              ]),
              vue.withDirectives(vue.createElementVNode(
                "input",
                {
                  ...
                  placeholder: "请输入作者",
                  class: "author",
                  "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => vue.unref(detail).author = $event)
                },
                null,
                512
                /* NEED_PATCH */
              ), [
                [vue.vModelText, vue.unref(detail).author]
              ]),
              vue.withDirectives(vue.createElementVNode(
                "textarea",
                {
                  ...
                  class: "context",
                  placeholder: "请输入详细内容",
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => vue.unref(detail).context = $event)
                },
                null,
                512
                /* NEED_PATCH */
              ), [
                [vue.vModelText, vue.unref(detail).context]
              ]),
              vue.createElementVNode("view", { class: "file" }, [
                vue.createVNode(_component_uni_file_picker, {
                  modelValue: vue.unref(imageValue),
              ...
              vue.createElementVNode("button", {
                ...
                type: "primary",
                onClick: Updated,
                disabled: !vue.unref(isshowbutton)
              }, "确定", 8, ["disabled"])
            ])
  ...
  const PagesEditEdit = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ecc27760"], ["__file", "D:/MYproject/Uni-cloud/richucloudapp/pages/Edit/Edit.vue"]]);
  const _sfc_main$1 = {
    __name: "detail",
    setup(__props) {
      let Article = vue.ref({});
      ...
      const getDatetime = vue.computed(() => {
      ...
      return (_ctx, _cache) => {
        ...
        return vue.openBlock(), vue.createElementBlock("view", { class: "detail" }, [
          vue.unref(isshow) ? (vue.openBlock(), vue.createElementBlock("view", { key: 0 }, [
            vue.createElementVNode(
              "view",
              { class: "title" },
              vue.toDisplayString(vue.unref(Article).title),
              1
              /* TEXT */
            ),
            vue.createElementVNode("view", { class: "info" }, [
              vue.createElementVNode(
                "text",
                { class: "author" },
                vue.toDisplayString(vue.unref(Article).author),
                1
                /* TEXT */
              ),
              vue.createElementVNode(
                "text",
                { class: "posttime" },
                vue.toDisplayString(getDatetime.value),
                1
                /* TEXT */
              )
            ]),
            vue.createElementVNode("view", { class: "content" }, [
              vue.createElementVNode(
                ...
                vue.toDisplayString(vue.unref(Article).context),
                1
                /* TEXT */
              )
            ]),
            vue.unref(Article).imageURL ? (vue.openBlock(), vue.createElementBlock("view", {
              key: 0,
              class: "imgs"
            }, [
              (vue.openBlock(true), vue.createElementBlock(
                vue.Fragment,
                null,
                vue.renderList(vue.unref(Article).imageURL, (item, index) => {
  ...
  const PagesDetailDetail = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__file", "D:/MYproject/Uni-cloud/richucloudapp/pages/detail/detail.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/MYproject/Uni-cloud/richucloudapp/App.vue"]]);
  function createApp() {
